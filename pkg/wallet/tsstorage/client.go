...
// NewClient returns a WalletStorageProvider that speaks the legacy JSON-RPC
// contract (POST /) served by the TypeScript wallet-toolbox StorageServer.
// Authenticated via BRC-103 AuthFetch using the given wallet for signing.
func NewClient(addr string, wallet sdk.Interface, opts ...ClientOptions) (*Client, func(), error) {
